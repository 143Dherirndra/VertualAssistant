...
//   const [assistant, setassistant] = useState(userData || "")
//   return (
...
//        Enter your <span className="text-blue-300">AI Assistant Name</span><br />
...
//           text-white px-2 rounded-full h-[60px] border-2 border-white bg-transparent"
//           onChange={(e)=>setassistant(e.target.value)}
//           value={assistant}
//         />
//         {userData && <button className="min-w-[300px] h-[50px] rounded-full mt-10 cursor-pointer
//           font-semibold text-[18px] text-white bg-blue-600 hover:bg-blue-700 transition"
//      onClick={()=>navigate('/customized2')}>
//         finaly Create your Assistsnt
//       </button>}
